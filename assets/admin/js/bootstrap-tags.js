...
(function($) {
    ...
    (function() {
        ...
        Tags.Templates["2"].input = function(options) {
            ...
            return "<input type='text' id='taglist' name='taglist' class='tags-input input-" + tagSize + "' />";
        };
    }).call(this);
    (function() {
        var _base;
    ...
    (function() {
        ...
        Tags.Templates["3"].input = function(options) {
            ...
            return "<input type='text' id='taglist' name='taglist' class='form-control tags-input input-" + options.tagSize + "' />";
        };
    }).call(this);
    (function() {
        var _base;
